...
class tabla{
	...
	public function Adicionar($identifica, $contrasena, $nombre, $correo1, $correo2)
	{
		...
		$Sentencia->bindValue(":correo1", $correo1);
		$Sentencia->bindValue(":correo2", $correo2);
		$Sentencia->bindValue(":rol", 0); //Administrador
	...
	{
		$SQL = "SELECT usuarios.codigo, usuarios.identifica, usuarios.nombre, usuarios.correo1, usuarios.correo2 FROM usuarios WHERE usuarios.rol = 0 ORDER BY usuarios.nombre LIMIT $posicion, $this->Mostrar";
		$Sentencia = $this->BaseDatos->Conexion->prepare($SQL);
		$Sentencia->execute();  //Ejecuta la consulta
	...
	public function actualiza1() { return "../../vista/usuarioadmin/actualiza1.html"; }
	public function actualiza2() { return "../../vista/usuarioadmin/actualiza2.html"; }
	public function adiciona1() { return "../../vista/usuarioadmin/adiciona1.html"; }
	public function adiciona2() { return "../../vista/usuarioadmin/adiciona2.html"; }
	public function borra1() { return "../../vista/usuarioadmin/borra1.html"; }
	public function borra2() { return "../../vista/usuarioadmin/borra2.html"; }
	public function busca1() { return "../../vista/usuarioadmin/busca1.html"; }
	public function busca2() { return "../../vista/usuarioadmin/busca2.html"; }
	public function detalle() { return "../../vista/usuarioadmin/detalle.html"; }
	public function registros() { return "../../vista/usuarioadmin/registros.html"; }
	public function rutaprog() { return "../../prog/usuarioadmin/"; }
	public function rutavista() { return "../../vista/usuarioadmin/"; }
}