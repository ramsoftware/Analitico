...
class tabla{
	...
	public function Adicionar($identifica, $contrasena, $nombre, $correo1, $correo2)
	{
		...
		$Sentencia->bindValue(":correo1", $correo1);
		$Sentencia->bindValue(":correo2", $correo2);
		$Sentencia->bindValue(":rol", 1); //Básica
	...
	{
		$SQL = "SELECT usuarios.codigo, usuarios.identifica, usuarios.nombre, usuarios.correo1, usuarios.correo2 FROM usuarios WHERE usuarios.rol = 1 ORDER BY usuarios.nombre LIMIT $posicion, $this->Mostrar";
		$Sentencia = $this->BaseDatos->Conexion->prepare($SQL);
		$Sentencia->execute();  //Ejecuta la consulta
	...
	public function actualiza1() { return "../../vista/usuariobasica/actualiza1.html"; }
	public function actualiza2() { return "../../vista/usuariobasica/actualiza2.html"; }
	public function adiciona1() { return "../../vista/usuariobasica/adiciona1.html"; }
	public function adiciona2() { return "../../vista/usuariobasica/adiciona2.html"; }
	public function borra1() { return "../../vista/usuariobasica/borra1.html"; }
	public function borra2() { return "../../vista/usuariobasica/borra2.html"; }
	public function busca1() { return "../../vista/usuariobasica/busca1.html"; }
	public function busca2() { return "../../vista/usuariobasica/busca2.html"; }
	public function detalle() { return "../../vista/usuariobasica/detalle.html"; }
	public function registros() { return "../../vista/usuariobasica/registros.html"; }
	public function rutaprog() { return "../../prog/usuariobasica/"; }
	public function rutavista() { return "../../vista/usuariobasica/"; }
}