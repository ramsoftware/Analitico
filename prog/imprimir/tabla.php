...
prodacademicaprof  FROM usuarios WHERE codigo = (SELECT docente FROM catedras WHERE codigo = :catedra)";
	...
	public function analitico() { return "../../vista/imprimir/imprimir.html"; }
	public function rutaprog() { return "../../prog/imprimir/"; }
	public function rutavista() { return "../../vista/imprimir/"; }
}